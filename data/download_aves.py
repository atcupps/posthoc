...
SYMBOLIC_LINK_PATH = "./src/dataset/semi-aves"
...
try:
    os.symlink(os.path.abspath(real_path_annotation), symlink_annotation_path)
...
try:
    os.symlink(os.path.abspath(real_path_test), symlink_test_path)
...
try:
    os.symlink(os.path.abspath(real_path_trainval_images), symlink_trainval_images_path)
...
try:
    os.symlink(os.path.abspath(real_path_trainval_u_train_in_path), symlink_trainval_u_train_in_path)
...
try:
    os.symlink(os.path.abspath(real_path_trainval_u_train_out_path), symlink_trainval_u_train_out_path)
