...
if __name__ == "__main__":
    ...
    with open(f'../../../../POC/data/fungitastic-m/fungitastic-m_labels.json', 'w') as f:   
    ...
    with open(f'../../../../POC/data/fungitastic-m/train.txt', 'w') as f:
        f.write("\n".join(train_split))
    print(f"Saved train.txt, {len(train_split)} images.")
    with open(f'../../../../POC/data/fungitastic-m/test.txt', 'w') as f:
        f.write("\n".join(test_split))
    ...
    for seed in fewshot_seeds:
        ...
        for kshot in fewshot_kshots:
            ...
            with open(f'../../../../POC/data/fungitastic-m/fewshot{kshot}_seed{seed}.txt', 'w') as f:
                f.write("\n".join(fewshot_split))
